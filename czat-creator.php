...
session_start();
if (!($_SESSION['login'])){
    echo "<script>location.href='./includes/admin-login.php';</script>";
}
        ...
        <div class="contentHolder">
            ...
            <div class="msgSendhold">
                ...
                <?php
                        ...
                        echo '<form name="wiad" action="./includes/czat-creator-handler.php" onsubmit="return validateForm()" method="post" >
            ...
            <div class="msgSendhold">
                ...
                <?php
                        if (empty($results)){
                            ...
                            echo '<form name="wiad" action="./includes/czat-deleter-handler.php" onsubmit="return validateForm()" method="post" >';
                ...
                <?php
                    if (empty($results)){
                        echo '<p> no chats to remove messages from </p>';
                                ...
                                echo '<form name="wiad" action="./includes/czat-emptier-handler.php" onsubmit="return validateForm()" method="post" >';
                                echo '<select name="chatid" id="chatDeleteSelector" class="nazwaChatu">';
                                foreach($results as $row){
                                    echo '<option value='.$row["lp"].'>'.$row["lp"].":".$row["chat_name"]. '</option>';
